...
class Database():
    ...
    def create_db(self):
        try:
            query = ('CREATE TABLE IF NOT EXISTS users ( id INTEGER PRIMARY KEY, user_name TEXT, user_phone TEXT, telegram_id TEXT);'
                     'CREATE TABLE IF NOT EXISTS place (id INTEGER PRIMARY KEY, name_palce TEXT,  place_address TEXT);'
                     'CREATE TABLE IF NOT EXISTS games (id INTEGER PRIMARY KEY, place_id TEXT, data_game TEXT, time_game TEXT, min_player INTEGER, max_player INTEGER, price TEXT)')
